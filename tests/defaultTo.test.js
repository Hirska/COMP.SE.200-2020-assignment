...
describe('defaultTo', () => {
    ...
    test('1: value is Nan, null or undefined 1', () => {
        const result = defaultTo(NaN, 2);
        expect(result).toEqual(2);
    });

    test('2: value is Nan, null or undefined 2', () => {
        const result2 = defaultTo(null, 3);
        expect(result2).toEqual(3);
    });
    
    test('3: value is Nan, null or undefined 3', () => {
        const result3 = defaultTo(undefined, 6);
        expect(result3).toEqual(6);
    });
    
    test('4: value is Nan, null or undefined 4', () => {
