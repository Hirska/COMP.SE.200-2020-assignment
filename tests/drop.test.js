...
describe('drop', () => {
    ...
    test('1: Valid array and element to drop 1', () => {
        const result = drop([1, 2, 3]);
        expect(result).toEqual([2, 3]);
    });

    test('2: Valid array and element to drop 2', () => {
        const result2 = drop([1, 2, 3], 2);
        expect(result2).toEqual([3]);
    });
    
    test('3: Valid array and element to drop 3', () => {
        const result3 = drop([1, 2, 3], 5);
        expect(result3).toEqual([]);
    });
    
    test('4: Valid array and element to drop 4', () => {
        const result4 = drop([1, 2, 3], 0);
        expect(result4).toEqual([1, 2, 3]);
    });

    test('5: Array is null, NaN or undefined 1', () => {
        const result = drop([1, 2, 3], -5);
        expect(result).toEqual([1, 2, 3]);
    });

    test('6: Array is null, NaN or undefined 2', () => {
        const result2 = drop([1, 2, 3], -3.7);
        expect(result2).toEqual([1, 2, 3]);
    });
    
    test('7: Array is null, NaN or undefined 3', () => {
        const result3 = drop([1, 2, 3, null], 3);
        expect(result3).toEqual([null]);
    });
    
    test('8: Array is null, NaN or undefined 4', () => {
        const result4 = drop([1, 2, 3, undefined], -4);
        expect(result4).toEqual([1, 2, 3, undefined]);
    });
    
    test('9: Array is null, NaN or undefined 5', () => {
